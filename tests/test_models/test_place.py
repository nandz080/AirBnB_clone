...
class test_Place(test_basemodel):
    ...
    def __init__(self, *args, **kwargs):
        """ testcase for initialization of place class"""
        super().__init__(*args, **kwargs)
        self.name = "Place"
        self.value = Place

    def test_city_id(self):
        """ testing place city_id attribute"""
        new = self.value()
    ...
    def test_number_bathrooms(self):
        """ testing place number of bathrooms attribute"""
        new = self.value()
    ...
    def test_price_by_night(self):
        """ testing place price by night attribute"""
        new = self.value()
    ...
    def test_latitude(self):
        """ testing place latitud attribute"""
        new = self.value()
